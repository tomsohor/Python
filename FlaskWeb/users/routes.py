...
from FlaskWeb.users.utils import save_pic,send_reset_email
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email hase been sent with instructions to reset your password.','info')
        return redirect(url_for('users.login'))
...
def reset_token(token):
    ...
    if user is None:
        flash('That is an invalid or expired token','waring')
